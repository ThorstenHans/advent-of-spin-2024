    ...
    pub mod scorer {
      ...
      pub fn score(name: &str,) -> u8{
        unsafe {
          ...
          #[link(wasm_import_module = "components:naughty-or-nice/scorer@0.1.0")]
          extern "C" {
            #[link_name = "score"]
...
B\x02\x01@\x01\x04names\0}\x04\0\x05score\x01\0\x03\0'components:naughty-or-nice\
/scorer@0.1.0\x05\0\x04\0\x19spin-deps:deps/deps@0.1.0\x04\0\x0b\x0a\x01\0\x04de\
ps\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.217.0\x10\
